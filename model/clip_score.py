...
model, preprocess = clip.load("/home/ubuntu/ESTRNN_Trans/pretrain_models/prompt_pretrain/ViT-B-32.pt", device=torch.device("cpu"))#"ViT-B/32"
model.to(device)
...
# 	def forward(self, pred_LL,gt_LL):
# 		prompt1=["a image of a discriminating scene", "a image of a astute scene","a image of a high definition scene"]
# 		prompt2=["a image of a blurry scene "]
# 		min_score=0
# 		max_index1=-1
# 		max_index2=-1
# 		for i, p1 in enumerate(prompt1):
# 			for j, p2 in enumerate(prompt2):
# 				score = get_clip_score(gt_LL, [p1, p2])
# 				if score < min_score:
# 					min_score = score
# 					max_index1 = i
# 					max_index2 = j
# 		k1 = get_clip_score(pred_LL,[prompt1[max_index1],prompt2[max_index2]])
# 		return k1
...
def get_clip_score(tensor,words):
	...
	for i in range(tensor.shape[0]):
		...
		if len(words)==2:
			...
			prob = (probs[0][3]+probs[0][2])/(probs[0][1]+probs[0][0])
			score =score + prob
...
class L_clip(nn.Module):
	...
	def forward(self, pred_LL,gg_LL_LL):
		# 24.1576
		# prompt1=["a image of a discriminating scene", "a image of a astute scene","a image of a high definition scene"]
		# prompt2=["a image of a blurry scene "]
		# 24.0375
		# prompt1=["a image of a discriminating scene", "a image of a astute scene","a image of a high definition scene"]
		# prompt2=["a image of a blurry scene ","a image of a fuzzy scene "]
		# 23.9010
		# prompt1=["a image of a high definition scene"]
		# prompt2=["a image of a blurry scene "]
		# 23.4112
		# prompt1=["a image of a discriminating scene","a image of a high definition scene"]
		# prompt2=["a image of a blurry scene "]
		# 23.1867
		# prompt1=["a image of a astute scene","a image of a high definition scene"]
		# prompt2=["a image of a blurry scene "]
		# 24.0533
		# prompt1=["a image of a discriminating scene", "a image of a astute scene","a image of a high definition scene"]
		# prompt2=["a image of a blurry scene", "a image of a blurred scene", "a image of a vague scene"]
		# 23.3574
		# prompt1=["a image of a discriminating scene","a image of a high definition scene"]
		# prompt2=["a image of a blurry scene", "a image of a vague scene"]
		# 23.7236
		# prompt1=["a image of a discriminating scene", "a image of a high definition scene"]
		# prompt2=["a image of a blurry scene", "a image of a blurred scene"]

		prompt1=["a image of a discriminating scene","a image of a high definition scene","a image of a blurry scene","a image of a blurred scene",]
		# prompt1=["a image of a clean scene","a image of a blurry scene "]
		k1 = get_clip_score(pred_LL,prompt1)
		# k2 = get_clip_score(gg_LL_LL,prompt1)
		# print(k1)
		return k1
...
res_model, res_preprocess = load("/home/ubuntu/ESTRNN_Trans/pretrain_models/prompt_pretrain/RN101.pt", device=device)
