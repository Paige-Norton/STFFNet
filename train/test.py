...
def test(para, logger):
    ...
    if not para.test_only:
        ...
        # para.test_checkpoint = join("/home/ubuntu/ESTRNN_Trans/experiment/2024_02_03_14_47_28_ESTRNN_BSD", 'model_best.pth.tar')
    ...
    for seq in seqs:
        ...
        while True:
            ...
            for frame_idx in range(start, end):
                ...
                blur_img_path = join(dataset_path, seq, 'blur', img_name[frame_idx] )
                sharp_img_path = join(dataset_path, seq, 'sharp', label_name[frame_idx])
            ...
            for frame_idx in range(para.past_frames, end - start - para.future_frames):
                # print("frame2222222222_idx:{}".format(frame_idx))
