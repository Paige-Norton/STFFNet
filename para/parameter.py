...
class Parameter:
    ...
    def extract_args(self):
        ...
        self.parser.add_argument('--testing', default=False, help='if true, it is testing')

        # clip
        self.parser.add_argument('--prompt_pretrain_dir', type=str, default= './pretrain_models/prompt_pretrain/pre_prompt_pair.pth')
        self.parser.add_argument('--length_prompt', type=int, default=16)
